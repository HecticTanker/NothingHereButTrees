...
//  I hard coded the EnvBumpScale because it was confusing the artist
	...
	float3 spectex = specTexture.x;  //this is the spec map, or dirt map
	float3 spectex2 = specTexture.y; // this is spec mask, to mix between sharp and convolved maps
	//float3 spectex3 = specTexture.z;  //this is a test of formation lights and headlights
